                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                            <div className="w-16 h-16 mx-auto mb-4">
                                <img src="feature-icon1.png" alt="Collaboration Icon" className="w-full h-full object-cover" />
                            </div>
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">Collaborative Assignments</h3>
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">Peer Review</h3>
                            <p className="text-gray-600">
